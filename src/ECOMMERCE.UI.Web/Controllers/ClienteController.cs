...
namespace ECOMMERCE.UI.Web.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(GeneralContext context)
        {
            _context = context;
        }
        ...
        {
            var generalContext = _context.Clientes.Include(c => c.Pessoa);
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,DataCadastro,Ativo,PessoaId")] Cliente cliente)
        {
            ...
            ViewData["PessoaId"] = new SelectList(_context.Pessoas, "PessoaId", "Nome", cliente.PessoaId);
            return View(cliente);
        }
